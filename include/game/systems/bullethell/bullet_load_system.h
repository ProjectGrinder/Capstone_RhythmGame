...
{
    // template<typename T>
    // void spawn_bullet(T &syscall, const Battle::BulletData& bullet_data, const Battle::BulletHellState bhs)
    // {
    ...
    //
    // template<typename T>
    // void load_bullets(T &syscall, System::ECS::Query<Battle::BulletLoader> &query, System::ECS::Query<Battle::BulletHellState> &query2)
    // {
