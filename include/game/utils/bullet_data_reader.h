...
inline Game::Battle::BulletRegistry read_bullet_data_from_file(const char *filepath)
{
    Game::Battle::BulletRegistry bullet_registry;
    ...
    while (std::getline(f, line))
    {
        ...
        else if (line.starts_with("collider"))
        {
            ...
            if (p2 == -1)
                ...
                current.collider_data = Game::Battle::ColliderData(
                        c,
