...
namespace Game::Render
{
    ...
    struct Material
    {
        ...
        Material() : vert_shader(nullptr), pixel_shader(nullptr), visible(false), render_prior(0), color(Color())
        {}
        explicit Material(char *vert_shader, char *pixel_shader) :
            vert_shader(vert_shader), pixel_shader(pixel_shader), visible(true), render_prior(0), color(Color())
        {}
