...
namespace Game::BulletHell
{
    ...
    struct Laser
    {
        ...
        Laser() : start_pos_x(0), start_pos_y(0), length(0), boom_frame(1000)
        {}

        Laser(const float start_pos_x, const float start_pos_y,const float length, const int boom_frame = 1000) :
