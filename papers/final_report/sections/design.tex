...
such as large quantity of notes and an accurate time tracking device centralized by a single system.
With entities as simple as notes and lanes, components are widely adjustable with speed and timing.
In addition, the system design is fairly simple as the input system are centralized and the
...
The core mechanic revolves around spawning the notes at the right time as set up and calculate the position of the sprite as it moves.
...
One of the proposed transition is a line animation that starts from the center of the screen and expands until it covers the whole screen.
