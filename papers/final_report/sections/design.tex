...
\noindent Figure~\ref{fig:designbullet} shows a current system design for bullet hell gameplay.
...
\\\\
\noindent The core mechanics are that, for each frame, the input was processed to control the player system.
...
In engine side, largely, the proposed design did not undergo major changes in the implementation process.
...
Meanwhile, in the gameplay side, the bullet hell system architecture has been mostly restructured.
to improve scalability, maintainability, and alignment with the overall game design.
