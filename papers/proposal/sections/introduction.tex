...
This project is intended to create high-precision software.
...
\\\\
As case studies, we will implement a rhythm game with bullet hell systems and
compete in the Talent Showcase competition by Thai Game Software Industry Association (TGA)
