...
% Software systems have been evolving over the years to adapt to changes of hardware and user requirements, 
% driven by new functionality requirements.
% Current systems in the market continue to improve their performance with every update released.
% However, it often depends on multiple configuration options, which can either speed-up or slow-down the performance depending on 
% how their compatibility.~\cite{Software_Performance_Evolution}
% \\\\
...
Upon reviewing existing systems and related work, it is evident that each system has its own strengths depending 
