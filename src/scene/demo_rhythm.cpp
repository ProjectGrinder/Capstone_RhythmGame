...
Game::Battle::ChartData Scene::create_level1_chart()
{
    ...
    chart.lanes[3].notes.emplace_back(true, 34925, 35821, Game::Battle::RhythmType::ACCENT);
    chart.lanes[0].notes.emplace_back(true, 35373, 35821, Game::Battle::RhythmType::ACCENT);
    ...
    chart.lanes[3].notes.emplace_back(false, 42985, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[0].notes.emplace_back(false, 43881, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[1].notes.emplace_back(false, 43881, 0, Game::Battle::RhythmType::NORMAL);
    ...
    chart.lanes[1].notes.emplace_back(false, 44776, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[3].notes.emplace_back(false, 45672, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[2].notes.emplace_back(false, 45672, 0, Game::Battle::RhythmType::NORMAL);
    ...
    chart.lanes[2].notes.emplace_back(false, 46567, 0, Game::Battle::RhythmType::NORMAL);
    ...
    chart.lanes[0].notes.emplace_back(false, 48806, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[1].notes.emplace_back(false, 49254, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[3].notes.emplace_back(false, 49254, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[0].notes.emplace_back(false, 49701, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[2].notes.emplace_back(false, 49701, 0, Game::Battle::RhythmType::NORMAL);
    ...
    chart.lanes[2].notes.emplace_back(true, 72537, 72985, Game::Battle::RhythmType::NORMAL);
    chart.lanes[3].notes.emplace_back(true, 72537, 72985, Game::Battle::RhythmType::NORMAL);
    chart.lanes[0].notes.emplace_back(true, 72985, 73433, Game::Battle::RhythmType::NORMAL);
    chart.lanes[1].notes.emplace_back(true, 72985, 73433, Game::Battle::RhythmType::NORMAL);
    ...
    chart.lanes[2].notes.emplace_back(false, 125373, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[1].notes.emplace_back(false, 125709, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[3].notes.emplace_back(false, 125709, 0, Game::Battle::RhythmType::NORMAL);
    ...
    chart.lanes[0].notes.emplace_back(false, 131642, 0, Game::Battle::RhythmType::NORMAL);
    ...
    chart.lanes[0].notes.emplace_back(true, 132537, 132761, Game::Battle::RhythmType::NORMAL);
    chart.lanes[3].notes.emplace_back(false, 132985, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[1].notes.emplace_back(true, 132985, 133209, Game::Battle::RhythmType::NORMAL);
    ...
    chart.lanes[3].notes.emplace_back(false, 134328, 0, Game::Battle::RhythmType::RAIN);
    chart.lanes[3].notes.emplace_back(false, 134552, 0, Game::Battle::RhythmType::RAIN);
    chart.lanes[2].notes.emplace_back(false, 134776, 0, Game::Battle::RhythmType::RAIN);
    chart.lanes[2].notes.emplace_back(false, 135000, 0, Game::Battle::RhythmType::RAIN);
    chart.lanes[1].notes.emplace_back(false, 135224, 0, Game::Battle::RhythmType::RAIN);
    chart.lanes[1].notes.emplace_back(false, 135448, 0, Game::Battle::RhythmType::RAIN);
    chart.lanes[0].notes.emplace_back(false, 135672, 0, Game::Battle::RhythmType::RAIN);
    chart.lanes[0].notes.emplace_back(false, 135896, 0, Game::Battle::RhythmType::RAIN);
    chart.lanes[1].notes.emplace_back(false, 136119, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[2].notes.emplace_back(false, 136119, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[1].notes.emplace_back(false, 136567, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[2].notes.emplace_back(false, 136567, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[0].notes.emplace_back(false, 137015, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[3].notes.emplace_back(false, 137015, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[0].notes.emplace_back(false, 137463, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[3].notes.emplace_back(false, 137463, 0, Game::Battle::RhythmType::NORMAL);
    chart.lanes[1].notes.emplace_back(true, 137910, 139701, Game::Battle::RhythmType::ACCENT);
    chart.lanes[2].notes.emplace_back(true, 137910, 139701, Game::Battle::RhythmType::ACCENT);

    // Total notes = 204 notes + 43 holds = 247
    return (chart);
}
